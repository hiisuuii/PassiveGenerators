...
public class GeneratorNetheriteTE extends GeneratorBaseTE {
	
	private int rfPerTick = 1024;
	
	public GeneratorNetheriteTE() {
		super(TileInit.TE_GENERATOR_NETHERITE.get());
	}
